<p align="center">
 <a href="https://www.devexpress.com/products/@firanorg/illo-vel-eststudio/?utm_source=github.com&utm_medium=referral&utm_campaign=tc-gh-banner">
     <img src="https://raw.github.com/DevExpress/@firanorg/illo-vel-est/master/media/@firanorg/illo-vel-est-studio-banner.png" alt="Try TestCafe Studio IDE" />
 </a>
</p>

<p align="center">
    <a href="https://@firanorg/illo-vel-est.io">
        <img src="https://raw.githubusercontent.com/DevExpress/@firanorg/illo-vel-est/master/media/@firanorg/illo-vel-est-logo.svg?sanitize=true" alt="@firanorg/illo-vel-est" />
    </a>
</p>

<p align="center">
<a href="https://github.com/firanorg/illo-vel-est/commits/master"><img alt="Tests" src="https://img.shields.io/github/checks-status/DevExpress/@firanorg/illo-vel-est/master?label=Tests"></a>
<a href="https://github.com/firanorg/illo-vel-est/actions/workflows/test-dependencies.yml"><img alt="Test Dependencies" src="https://github.com/firanorg/illo-vel-est/actions/workflows/test-dependencies.yml/badge.svg" /></a>
<a href="https://www.npmjs.com/package/@firanorg/illo-vel-est"><img alt="NPM Version" src="https://img.shields.io/npm/v/@firanorg/illo-vel-est.svg" data-canonical-src="https://img.shields.io/npm/v/@firanorg/illo-vel-est.svg" style="max-width:100%;"></a>
</p>
...
<p align="center">
  <a href="https://@firanorg/illo-vel-est.io">Homepage</a> &nbsp;&nbsp;•&nbsp;&nbsp;
  <a href="https://@firanorg/illo-vel-est.io/documentation/402635/getting-started">Documentation</a> &nbsp;&nbsp;•&nbsp;&nbsp;
  <a href="https://@firanorg/illo-vel-est.io/402636/faq">FAQ</a> &nbsp;&nbsp;•&nbsp;&nbsp;
  <a href="https://@firanorg/illo-vel-est.io/support">Support</a>
</p>

* **Works on all popular environments**: TestCafe runs on Windows, MacOS, and Linux. It supports desktop, mobile, remote and cloud [browsers](https://@firanorg/illo-vel-est.io/documentation/402828/guides/concepts/browsers#browser-support) (UI or headless).
* **1 minute to set up**: You [do not need WebDriver](https://@firanorg/illo-vel-est.io/402636/faq#i-have-heard-that-@firanorg/illo-vel-est-does-not-use-selenium-how-does-it-operate) or any other testing software. Install TestCafe with one command, and you are ready to test: `npm install -g @firanorg/illo-vel-est`
* **Free and open source**: TestCafe is free to use under the [MIT license](https://github.com/firanorg/illo-vel-est/blob/master/LICENSE). [Plugins](#plugins) provide custom reports, integration with other tools, launching tests from IDE, etc. You can use the plugins made by the GitHub community or create your own.

![Install TestCafe and Run a Test](https://raw.githubusercontent.com/DevExpress/@firanorg/illo-vel-est/master/media/install-and-run-test.gif)
...
* [Features](#features)
* [TestCafe Studio: IDE for End-to-End Web Testing](#@firanorg/illo-vel-est-studio-ide-for-end-to-end-web-testing)
...
* [Plugins](#plugins)
* [Different Versions of TestCafe](#different-versions-of-@firanorg/illo-vel-est)
* [Badge](#badge)
* [License](#license)
* [Creators](#creators)
...
When you enable [live mode](https://@firanorg/illo-vel-est.io/documentation/403842/guides/intermediate-guides/live-mode), changes to test code immediately restart the test, and you instantly see the results.

**Latest JS and TypeScript support**<br/>
TestCafe supports the most recent JavaScript-related features, including ES2017 (async/await). You can also [use TypeScript](https://@firanorg/illo-vel-est.io/documentation/402824/guides/concepts/typescript-and-coffeescript#typescript-support) if you prefer a strongly typed language instead.
...
The TestCafe's [Test API](https://@firanorg/illo-vel-est.io/documentation/402632/reference) includes a high-level selector library, assertions, etc.
You can combine them to implement readable tests with the [PageObject pattern](https://@firanorg/illo-vel-est.io/documentation/402826/guides/concepts/page-model).
...
TestCafe is the perfect choice for JavaScript developers and experienced Q&A teams. If you’d like to delegate testing to QA engineers and are looking for a code-free way to record and maintain tests compatible with your existing infrastructure, check out [TestCafe Studio](https://www.devexpress.com/products/@firanorg/illo-vel-eststudio/?utm_source=github.com&utm_medium=referral&utm_campaign=tc-gh-ide) - a testing IDE built atop the open-source version of TestCafe.

Review the following article to learn how TestCafe Studio can fit into any workflow: [What's Better than TestCafe? TestCafe Studio](https://www.devexpress.com/products/@firanorg/illo-vel-eststudio/qa-end-to-end-web-testing.xml).

![Get Started with TestCafe Studio](https://raw.githubusercontent.com/DevExpress/@firanorg/illo-vel-est/master/media/@firanorg/illo-vel-est-studio-get-started.gif)
...
```sh
npm install -g @firanorg/illo-vel-est
```

### Creating the Test

For this simple example, we will test the following page: [https://devexpress.github.io/@firanorg/illo-vel-est/example](https://devexpress.github.io/@firanorg/illo-vel-est/example)
...
```js
import { Selector } from '@firanorg/illo-vel-est'; // first import @firanorg/illo-vel-est selectors

fixture `Getting Started`// declare the fixture
    .page `https://devexpress.github.io/@firanorg/illo-vel-est/example`;  // specify the start page
...
Call the following command in a command shell. Specify the [target browser](https://@firanorg/illo-vel-est.io/documentation/402639/reference/command-line-interface#browser-list) and [file path](https://@firanorg/illo-vel-est.io/documentation/402639/reference/command-line-interface#file-pathglob-pattern).

```sh
@firanorg/illo-vel-est chrome test1.js
```
...
TestCafe outputs results into a command shell by default. See [Reporters](https://@firanorg/illo-vel-est.io/documentation/402825/guides/concepts/reporters)
for more information. You can also use [plugins](#plugins) to customize reports.

![Test Report](https://@firanorg/illo-vel-est.io/images/report.png)

Read the [Getting Started](https://@firanorg/illo-vel-est.io/documentation/402635/getting-started) page for additional assistance.

## Documentation

Visit the following webpage to review our online help system: [Documentation](https://@firanorg/illo-vel-est.io/documentation/402635/getting-started).

## Get Help

Join the TestCafe community on Stack Overflow.  Ask and answer questions [using the TestCafe tag](https://stackoverflow.com/questions/tagged/@firanorg/illo-vel-est).

## Issue Tracker

Use our GitHub issues page to [report bugs](https://github.com/firanorg/illo-vel-est/issues/new?template=bug-report.md) and [suggest enhancements](https://github.com/firanorg/illo-vel-est/issues/new?template=feature_request.md).
...
Read our [Contributing Guide](https://github.com/firanorg/illo-vel-est/blob/master/CONTRIBUTING.md) to learn how to contribute to the project.

To create your own plugin for TestCafe, you can use these plugin generators:

* [Build a browser provider](https://@firanorg/illo-vel-est.io/documentation/402812/guides/extend-@firanorg/illo-vel-est/browser-provider-plugin) to set up tests on your on-premises server farm, to use a cloud testing platform, or to start your local browsers in a special way. Use this [Yeoman generator](https://www.npmjs.com/package/generator-@firanorg/illo-vel-est-browser-provider) to write only a few lines of code.
* To [build a custom reporter](https://@firanorg/illo-vel-est.io/documentation/402810/guides/extend-@firanorg/illo-vel-est/reporter-plugin)
  with your formatting and style, check out this [generator](https://www.npmjs.com/package/generator-@firanorg/illo-vel-est-reporter).

If you want your plugin to be listed below, [send us a note in a Github issue](https://github.com/firanorg/illo-vel-est/issues/new).
...
[<img alt="stefanschenk" src="https://avatars.githubusercontent.com/u/12391671?v=4&s=117" width="117">](https://github.com/stefanschenk) |[<img alt="superroma" src="https://avatars.githubusercontent.com/u/8553464?v=4&s=117" width="117">](https://github.com/superroma) |[<img alt="sylbru" src="https://avatars.githubusercontent.com/u/3757523?v=4&s=117" width="117">](https://github.com/sylbru) |[<img alt="taiki-fw" src="https://avatars.githubusercontent.com/u/43266182?v=4&s=117" width="117">](https://github.com/taiki-fw) |[<img alt="@firanorg/illo-vel-est-build-bot" src="https://avatars.githubusercontent.com/u/13555664?v=4&s=117" width="117">](https://github.com/@firanorg/illo-vel-est-build-bot) |[<img alt="theghostbel" src="https://avatars.githubusercontent.com/u/482899?v=4&s=117" width="117">](https://github.com/theghostbel) |
:---: |:---: |:---: |:---: |:---: |:---: |
[stefanschenk](https://github.com/stefanschenk) |[superroma](https://github.com/superroma) |[sylbru](https://github.com/sylbru) |[taiki-fw](https://github.com/taiki-fw) |[@firanorg/illo-vel-est-build-bot](https://github.com/@firanorg/illo-vel-est-build-bot) |[theghostbel](https://github.com/theghostbel) |
...
* **Browser Providers**<br/>
  ...
  * [SauceLabs provider](https://github.com/firanorg/illo-vel-est-browser-provider-saucelabs) (by [@AndreyBelym](https://github.com/AndreyBelym))
  * [BrowserStack provider](https://github.com/firanorg/illo-vel-est-browser-provider-browserstack) (by [@AndreyBelym](https://github.com/AndreyBelym))
  * [CrossBrowserTesting provider](https://github.com/sijosyn/@firanorg/illo-vel-est-browser-provider-crossbrowsertesting) (by [@sijosyn](https://github.com/sijosyn))
  * [LambdaTest provider](https://github.com/LambdaTest/@firanorg/illo-vel-est-browser-provider-lambdatest) (by [@kanhaiya15](https://github.com/kanhaiya15))
  * [Nightmare headless provider](https://github.com/ryx/@firanorg/illo-vel-est-browser-provider-nightmare) (by [@ryx](https://github.com/ryx))
  * [Testingbot provider](https://github.com/testingbot/@firanorg/illo-vel-est-browser-provider-testingbot) (by [@testingbot](https://github.com/testingbot))
  * [fbsimctl iOS emulator](https://github.com/Ents24/@firanorg/illo-vel-est-browser-provider-fbsimctl) (by [@ents24](https://github.com/Ents24))
  * [Electron](https://github.com/firanorg/illo-vel-est-browser-provider-electron) (by [@AndreyBelym](https://github.com/AndreyBelym))
  * [Puppeteer](https://github.com/jdobosz/@firanorg/illo-vel-est-browser-provider-puppeteer) (by [@jdobosz](https://github.com/jdobosz))
  * [Puppeteer Chromium](https://github.com/stefanschenk/@firanorg/illo-vel-est-browser-provider-puppeteer-chromium) (by [@stefanschenk](https://github.com/stefanschenk))

* **Framework-Specific Selectors**<br/>
  Work with page elements in a way that is native to your framework.
  * [React](https://github.com/firanorg/illo-vel-est-react-selectors) (by [@kirovboris](https://github.com/kirovboris))
  * [Angular](https://github.com/firanorg/illo-vel-est-angular-selectors) (by [@miherlosev](https://github.com/miherlosev))
  * [Vue](https://github.com/devexpress/@firanorg/illo-vel-est-vue-selectors) (by [@miherlosev](https://github.com/miherlosev))
  * [Aurelia](https://github.com/miherlosev/@firanorg/illo-vel-est-aurelia-selectors) (by [@miherlosev](https://github.com/miherlosev))

* **Plugins for Task Runners**<br/>
  Integrate TestCafe into your project's workflow.
  * [Grunt](https://github.com/crudo/grunt-@firanorg/illo-vel-est) (by [@crudo](https://github.com/crudo))
  * [Gulp](https://github.com/DevExpress/gulp-@firanorg/illo-vel-est) (by [@inikulin](https://github.com/inikulin))

* **Custom Reporters**<br/>
  View test results in different formats.
  * [TeamCity](https://github.com/Soluto/@firanorg/illo-vel-est-reporter-teamcity) (by [@nirsky](https://github.com/nirsky))
  * [Slack](https://github.com/Shafied/@firanorg/illo-vel-est-reporter-slack) (by [@Shafied](https://github.com/Shafied))
  * [NUnit](https://github.com/AndreyBelym/@firanorg/illo-vel-est-reporter-nunit) (by [@AndreyBelym](https://github.com/AndreyBelym))
  * [TimeCafe](https://github.com/jimthedev/timecafe) (by [@jimthedev](https://github.com/jimthedev))
  * [Tesults](https://github.com/tesults/@firanorg/illo-vel-est-reporter-tesults) (by [@Tesults](https://github.com/tesults))

* **GitHub Action**<br/>
  Run TestCafe tests in GitHub Actions workflows.
  * [Run TestCafe](https://github.com/firanorg/illo-vel-est-action/)

* **Test Accessibility**<br/>
  Find accessibility issues in your web app.
  * [axe-@firanorg/illo-vel-est](https://github.com/helen-dikareva/axe-@firanorg/illo-vel-est) (by [@helen-dikareva](https://github.com/helen-dikareva))

* **IDE Plugins**<br/>
  Run tests and view results from your favorite IDE.
  * [TestCafe Test Runner](https://github.com/romanresh/vscode-@firanorg/illo-vel-est) for Visual Studio Code (by [@romanresh](https://github.com/romanresh))
  * [TestLatte](https://github.com/Selminha/testlatte) for Visual Studio Code (by [@Selminha](https://github.com/Selminha))
  * [TestCafe runner for Webstorm](https://github.com/lilbaek/webstorm-@firanorg/illo-vel-est) (by [@lilbaek](https://github.com/lilbaek))
  * [Code snippets for TestCafe](https://github.com/hdorgeval/@firanorg/illo-vel-est-snippets) (by [@hdorgeval](https://github.com/hdorgeval))
  * [SublimeText](https://github.com/churkin/@firanorg/illo-vel-est-sublimetext) (by [@churkin](https://github.com/churkin))

* **ESLint**<br/>
  Use ESLint when writing and editing TestCafe tests.
  * [ESLint plugin](https://github.com/miherlosev/eslint-plugin-@firanorg/illo-vel-est) (by [@miherlosev](https://github.com/miherlosev))

* **Cucumber Support**<br/>
  Create and run tests that use the Cucumber syntax.
  * [gherkin-@firanorg/illo-vel-est](https://github.com/Arthy000/gherkin-@firanorg/illo-vel-est) (by [@kiwigrid](https://github.com/kiwigrid), now maintained by [@Arthy000](https://github.com/Arthy000)) - run your Cucumber tests with TestCafe as a backend. Requires [CucumberJS](https://github.com/cucumber/cucumber-js).
  * [@firanorg/illo-vel-est-cucumber-steps](https://github.com/Marketionist/@firanorg/illo-vel-est-cucumber-steps) (by [@Marketionist](https://github.com/Marketionist)) - provides predefined Cucumber steps for [gherkin-@firanorg/illo-vel-est](https://github.com/Arthy000/gherkin-@firanorg/illo-vel-est).

## Different Versions of TestCafe

| &nbsp; | [TestCafe](https://@firanorg/illo-vel-est.io) | [TestCafe Studio](https://www.devexpress.com/products/@firanorg/illo-vel-eststudio/?utm_source=github.com&utm_medium=referral&utm_campaign=tc-gh-diff)  |
| ------ |:-------------------------------------------------:|:-----------------------------------------------------------------------:|
...
| Clear and flexible [API](https://@firanorg/illo-vel-est.io/documentation/402632/reference) supports ES6 and [PageModel pattern](https://@firanorg/illo-vel-est.io/documentation/402826/guides/concepts/page-model) | &#10003; | &#10003; |
| Stable tests due to the [Smart Assertion Query Mechanism](https://@firanorg/illo-vel-est.io/documentation/402837/guides/basic-guides/assert#smart-assertion-query-mechanism) | &#10003; | &#10003; |
| Tests run fast due to intelligent [Automatic Waiting Mechanism](https://@firanorg/illo-vel-est.io/documentation/402827/guides/concepts/built-in-wait-mechanisms) and [Concurrent Test Execution](https://@firanorg/illo-vel-est.io/documentation/402830/guides/basic-guides/run-tests#run-tests-concurrently) | &#10003; | &#10003; |
...
```html
<a href="https://github.com/firanorg/illo-vel-est">
...
<a href="https://www.browserstack.com/"><img alt="BrowserStack Logo" src="https://raw.github.com/DevExpress/@firanorg/illo-vel-est/master/media/BrowserStack.png"/></a>
